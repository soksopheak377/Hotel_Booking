              ...
              <div class="form-group">
            	...
            	<div class="form-group">
                      ...
                      <?php foreach ($roomtypes as $keyroom) {
                        $is_selected = '';
                        if($keyroom->tid == $rows[0]->tid){
                          $is_selected = "selected";
                        }
                    ?>
                    <option data-id="<?php echo @$keyroom->tid; ?>" data-name="<?php echo  @$keyroom->tname; ?>" value="<?php echo $keyroom->tid; ?>" <?php echo $is_selected ?>><?php echo @$keyroom->tname; ?></option>
                    <?php } ?>
                		</select>
              		</div>
            	</div>
